...
/**
 * Write a description of class CityHard here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CityHard extends World
{
private Frog myFrog;
    private int counter;
    ...
    public void act(){
        ...
        placeCar6(10, 150, 33, 491);
        placeTurtle(-3, 150, 827, 382);
        placeWood2(2, 340, 74, 323);
        placeTurtle(-2, 240, 827, 259);
        placeTurtle(-10, 250, 827, 132);
    }
